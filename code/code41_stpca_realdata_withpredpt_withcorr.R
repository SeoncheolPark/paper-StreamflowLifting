...
#(November 10, 2020) predpoints에 있는 자료들을 obspoints에 추가
demoNet@obspoints@SSNPoints[[1]]@network.point.coords <- rbind(demoNet@obspoints@SSNPoints[[1]]@network.point.coords, demoNet@predpoints@SSNPoints[[1]]@network.point.coords)
demoNet@obspoints@SSNPoints[[1]]@point.coords <- rbind(demoNet@obspoints@SSNPoints[[1]]@point.coords, demoNet@predpoints@SSNPoints[[1]]@point.coords)
demoNet@obspoints@SSNPoints[[1]]@point.data <- rbind(demoNet@obspoints@SSNPoints[[1]]@point.data, demoNet@predpoints@SSNPoints[[1]]@point.data)
demoNet@obspoints@SSNPoints[[1]]@points.bbox[1,1] <- demoNet@obspoints@SSNPoints[[1]]@points.bbox[1,1]
demoNet@obspoints@SSNPoints[[1]]@points.bbox[1,2] <- demoNet@obspoints@SSNPoints[[1]]@points.bbox[1,2]
demoNet@obspoints@SSNPoints[[1]]@points.bbox[2,2] <- demoNet@obspoints@SSNPoints[[1]]@points.bbox[2,2]
...
########################################
#2nd revision 관련 시작(June 16, 2021)
########################################
library(condMVNorm)
...
########################################
#2nd revision 관련 끝(June 16, 2021)
########################################
...
for(ijk in 1:n.iter){
  ...
  TweedData2[1,c(3:5)] <- colMeans(TweedData[c(1:3),c(3:5)]) #1
  TweedData2[9,c(3:5)] <- colMeans(TweedData[c(9:11),c(3:5)]) #13
  TweedData2[12,c(3:5)] <- colMeans(TweedData[c(12:13),c(3:5)]) #14
  TweedData2[17,c(3:5)] <- colMeans(TweedData[c(17:18),c(3:5)]) #21
  TweedData2[20,c(3:5)] <- colMeans(TweedData[c(20:21),c(3:5)]) #23
  TweedData2[26,c(3:5)] <- colMeans(TweedData[c(26:28),c(3:5)]) #33
  TweedData2[30,c(3:5)] <- colMeans(TweedData[c(30:32),c(3:5)]) #48
  TweedData2[33,c(3:5)] <- colMeans(TweedData[c(33:34),c(3:5)]) #52
  TweedData2[35,c(3:5)] <- colMeans(TweedData[c(35:36),c(3:5)]) #55
  TweedData2[42,c(3:5)] <- colMeans(TweedData[c(42:43),c(3:5)]) #60
  TweedData2[44,c(3:5)] <- colMeans(TweedData[c(44:45),c(3:5)]) #61
  TweedData2[47,c(3:5)] <- colMeans(TweedData[c(47:48),c(3:5)]) #66
  TweedData2[52,c(3:5)] <- colMeans(TweedData[c(52:53),c(3:5)]) #73
  TweedData2[55,c(3:5)] <- colMeans(TweedData[c(55:56),c(3:5)]) #75
  TweedData2[57,c(3:5)] <- colMeans(TweedData[c(57:58),c(3:5)]) #77
  
  TweedData2 <- TweedData2[-c(2,3,10,11,13,18,21,27,28,31,32,34,36,43,45,48,53,56,58),]
 ...
 index_choose2 <- as.numeric(paste(demoNet@obspoints@SSNPoints[[1]]@point.data$rid))
  ...
  index_vec_imsi <- cbind(1:60, order(as.numeric(colnames(result_signal))))
